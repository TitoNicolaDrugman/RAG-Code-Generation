...
def build_baseline_prompt_v6_2(instruction: str) -> str:
    """
    Uppercase variant of v6 baseline.
    """
...
def build_rag_prompt_v6_2(instruction: str, retrieved: str) -> str:
    """
    Uppercase variant of v6 RAG.
    """
...
YOU ARE PROVIDED WITH 'RETRIEVED CODE EXAMPLES' FROM THIS LIBRARY TO GUIDE YOUR IMPLEMENTATION.
